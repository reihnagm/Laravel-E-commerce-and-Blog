  ...
  <div class="container">
    <div class="columns">
      ...
      <div class="column is-one-quarter">
        ...
        "user" => request()->user(),
        "blog_user_id" => $blog['user']['id'] ? $blog['user']['id']  : null ,
        "blog_user_name" => $blog['user']['name'] ? $blog['user']['name'] : null ,
        "blog_user_avatar" =>  $blog['user']['avatar'] ? $blog['user']['avatar'] :  null
        ])
      ...
      <div class="columns is-multiline" style="margin-top: 11.2%;">
        ...
        <div style="width: 100%;">
          <h3> {{ strtoupper($blog['user']['name']) }} Product's </h3>
          <hr>
        </div>
        ...
        <div class="column is-one-third">
          ...
          <div class="products">
            ...
            <span class="products-users-username"> Owner : {{ $product['user']['name'] }} </span>
        ...
        <div style="width: 100%;">
          <h3> {{ strtoupper($blog['user']['name']) }} Blog's </h3>
          <hr>
        </div>
