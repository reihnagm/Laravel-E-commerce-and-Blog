<template>
    <div>
              <div class="_columns _is_multiline _polls_in_mobile">
                    <div id="_responsive_polls" class="_column _is_one_third" v-for="poll in polls" :key="poll.id">
                         
                    <img class="_img_emotions" :src.literal="'/assets/emotions/'+ poll.question + '.png'">
                ...
                <div class="_column">
                    <a href="#!" :class="{'_button': true, 'disabled' : !isChecked }" @click.prevent="submit">Vote!</a> 
                </div>
    ...
    export default {
       ...
       methods:{
            ...
            submit()
            {
                ...
                if(this.isChecked)
                {
                    axios.post('/polls',{'id':this.option_id, 'blog_id': this.blog_id}).then((response) => {
